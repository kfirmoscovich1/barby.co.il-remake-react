/**
 * @file types/index.ts
 * @description Centralized TypeScript type definitions for the backend application.
 * 
 * This module contains all shared types used across the Express backend including:
